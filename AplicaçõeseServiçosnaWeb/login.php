            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <!--<li><a href="./contact.html">Apoio ao Cliente</a></li>
                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <!--<div class="group-input gi-check">
                                <div class="gi-more">
                                    ...
                                    <a href="#" class="forget-pass">Esqueceu-se da sua Password?</a>
                                </div>
                            </div>-->
                            <input type="submit" value="Login" class="site-btn login-btn">
                            <!--<button type="submit" class="site-btn login-btn">Iniciar Sessão</button>-->
                        </form>
                        
                        <div class="switch-login">
                            <a href="./register.php" class="or-login">Ou criar uma conta</a>
                        </div>
                    </div>
                </div>
            </div>
