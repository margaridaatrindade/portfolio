...
<body>
    ...
    <div class="map spad">
        <div class="container">
            <div class="map-inner">
                <iframe
                    src="https://www.google.com/maps/embed/v1/place?q=Faculdade+de+Ciências+da+Universidade+de+Lisboa,+Campo+Grande,+Lisboa,+Portugal&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                ...
                <div class="col-lg-5">
                    ...
                    <div class="contact-widget">
                        <div class="cw-item">
                            ...
                            <div class="ci-text">
                                <span>Morada:</span>
                                <p>Faculdade de Ciências, Universidade de Lisboa, Portugal</p>
                            </div>
                        </div>
                        <div class="cw-item">
                            <div class="ci-icon">
