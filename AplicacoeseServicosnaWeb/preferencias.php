            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="register-form">
                        <h2>Preferências</h2>
                        <p style="display:none;">Seu email: <span id="selectedEmail" name="selectedEmail"></span><br>
                        ...
                        <input type="hidden" id="emailSelecionado" name="emailSelecionado">
                        ...
                        var emailSelecionado = document.getElementById("selectedEmail").textContent;

                        // Define o valor do input hidden com o email selecionado
                        document.getElementById("emailSelecionado").value = emailSelecionado;
                        </script>
