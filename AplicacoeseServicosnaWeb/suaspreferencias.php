        ...
        <div class="container">
            <div class="checkout-form register-form">
                ...
                <!--<form id="email2" method="post">
                        ...
                        <input class='site-btn place-btn' type="submit" value="Procurar" id="pref">
                    </form>-->

                    <script>
                        const emailSelec = document.getElementById('email3');
                        const Button = document.getElementById('pref');
                        
                        Button.addEventListener('click', () => {
                          const selected = emailSelec.value;
                    ...
                    <div class="pref" >
                        ...
                        if(isset($_SESSION['utilizador'])) {
                            ...
                            $sql = "SELECT * FROM preferencias WHERE utilizador='$email'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<form method='POST' action='eliminarpreferencias.php' id='meuForm'>";
                                    echo "<div class='group-input formulario-item-50 item-esquerda'>";
                                    echo "<label for='categoria'>Categoria:</label>";
                                    echo "<input type='text' name='categoria' value='" . $categoria_nome . "'>";
                                    echo "</div>";
                                    echo "<div class='group-input formulario-item-50'>";
                                    echo "<label for='tamanho'>Tamanho:</label>";
                                    echo "<input type='text' name='tamanho' value='" . $tamanho_valor . "'>";
                                    echo "</div>";
                                    echo "<div class='group-input formulario-item-50 item-esquerda'>";
                                    echo "<label for='marca'>Marca:</label>";
                                    echo "<input type='text' name='marca' value='" . $marca_nome . "'>";
                                    echo "</div>";
                                    echo "<input type='hidden' name='email' value='" . $email . "'>";
                                    echo "<input class='' type='submit' name='submit' value='Eliminar preferência' id='enviar' >";
                                    echo "</form>";

                                    echo "<style>#email2 { display: none; }</style>";
                                }
                                echo "<form method='POST' action='alterarpreferencias.php' id='meuForm'>";
                                echo "<input class='site-btn place-btn' type='submit' name='submit' value='Adicionar preferências' id='enviar' >";
                                echo "</form>";
